...
public class SimpleProduct {
    ...
    public SimpleProduct(Product producto){
        this.product_id = producto.getCategory_id();
        this.gtin = producto.getGtin();
        this.product = producto.getProduct();
        this.description = producto.getDescription();
        this.price = producto.getPrice();
        this.stock = producto.getStock();
        this.category_id = producto.getCategory_id();
        this.status = producto.getProduct_id();
